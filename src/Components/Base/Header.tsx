      ...
      <div id="logo" className="w-full flex justify-between items-center gap-4">
        <div id="dxl-logo">
          <img
            ...
            alt="Danish Xbox League logo" width="150" height="100"
          />
        </div>
        <div id="festival-logo">
          <svg xmlns="http://www.w3.org/2000/svg" width={150} height={150} xmlSpace="preserve" viewBox="0 0 491.2 567.2" preserveAspectRatio="xMinYMid meet">
